...
const pageInfo = {
  isBitcoinPage: true,
  bitcoinPageInfo: {
    exchangeButtonText: 'Buy Bitcoin with USD',
    howToBuyButtonText: 'Buy BTC with USD',
    exchangeText: 'Choose payment method that suits you most and buy BTC with USD with the lowest fees.',
    howToBuyHeader: 'How to buy Bitcoin (BTC) with USD Instantly?',
    howToBuySubHeader:
      'Follow these simple steps to purchase Bitcoin with USD instantly using any major payment method.',
    fiatName: {
      upper: 'USD',
    },
  ...
  meta: {
    url: 'https://guardarian.com/buy-bitcoin-with-usd',
    title: `Buy ${coin.name} (${coin.tickerUpper}) with USD - Guardarian`,
    description: `Guardarian is the easiest way to buy & sell Bitcoin. Exchange USD to BTC and BTC to USD without registration or any hidden fees.`,
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: `Buy ${coin.name} (${coin.tickerUpper}) with USD Instantly`,
    text: 'Bitcoin is an independent currency. What distinguishes this cryptocurrency from common currencies such as dollars or euros is that it is not owned by any state. In other words, Bitcoin is  an essentially decentralized currency because there is no central bank, government, financial institution, or company that acts on them. With Guardarian you can buy BTC with US Dollars without registration and with no hidden fees. ',
    info: {
      release: 2009,

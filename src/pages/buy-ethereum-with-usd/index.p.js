...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Ethereum (ETH) with USD - Guardarian',
    description:
      'Guardarian is the easiest way to buy & sell Bitcoin. Exchange USD to ETH and ETH to USD without registration or any hidden fees.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Ethereum (ETH) with USD',

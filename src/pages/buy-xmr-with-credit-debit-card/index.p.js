...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Monero (XMR) With Credit/Debit Card - Guardarian',
    description:
      'Buy Monero fast with Visa or Mastercard without registration. Best exchange rate and no hidden fees on Guardarian.',
  },
  banner: {
    title: 'Buy Monero (XMR) with Credit/Debit Card',

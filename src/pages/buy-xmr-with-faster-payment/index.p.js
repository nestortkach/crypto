...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Monero (XMR) With Faster Payments - Guardarian',
    description:
      'Easiest way to buy & sell Monero with Faster Payments (FPS). No registration and best exchange rate on Guardarian. ',
  },
  banner: {
    title: 'Buy Monero (XMR) with Faster Payment',

...
const pageInfo = {
  isBitcoinPage: true,
  bitcoinPageInfo: {
    exchangeButtonText: 'Buy Bitcoin with Faster Payments',
    howToBuyButtonText: 'Buy BTC with Faster Payments',
    exchangeText:
      'Use Faster Payments to get Bitcoin in the United Kingdom. Secure transactions and no registration required ',
    howToBuyHeader: 'How to buy Bitcoin (BTC) in the UK with Faster payments?',
    howToBuySubHeader: 'Follow these simple steps to purchase Bitcoin in minutes using Faster Payments on Guardarian.',
    fiatName: {
      upper: 'USD',
    },
  ...
  meta: {
    url: 'https://guardarian.com/buy-bitcoin-with-faster-payment',
    title: `Buy ${coin.name} (${coin.tickerUpper}) With Faster Payments - Guardarian`,
    description: `Easiest way to buy & sell Bitcoin with Faster Payments (FPS). No registration and best exchange rate on Guardarian.`,
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: `Buy ${coin.name} (${coin.tickerUpper}) in UK with Faster Payments`,
    text: 'Bitcoin is an independent currency. What distinguishes this cryptocurrency from common currencies such as dollars or euros is that it is not owned by any state. In other words, Bitcoin is  an essentially decentralized currency because there is no central bank, government, financial institution, or company that acts on them. With Guardarian you can buy BTC in the UK near-instantly using Faster Payments.',
    info: {
      release: 2009,

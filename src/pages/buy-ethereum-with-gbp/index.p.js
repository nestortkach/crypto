...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Ethereum (ETH) with GBP - Guardarian',
    description:
      'Guardarian is the easiest way to buy & sell Ethereum. Exchange GBP to ETH and ETH to GBP without registration or any hidden fees.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Ethereum (ETH) with GBP',

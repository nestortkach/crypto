...
const pageInfo = {
  isBitcoinPage: true,
  bitcoinPageInfo: {
    exchangeButtonText: 'Buy Bitcoin with EUR',
    howToBuyButtonText: 'Buy BTC with EUR',
    exchangeText: 'Choose payment method that suits you most and buy BTC with EUR with the lowest fees.',
    howToBuyHeader: 'How to buy Bitcoin (BTC) with EUR Instantly?',
    howToBuySubHeader:
      'Follow these simple steps to purchase Bitcoin with EUR instantly using any major payment method.',
    fiatName: {
      upper: 'EUR',
    },
    isPaymentMethod: false,
    popularPaymantSubheader: 'Use EUR to buy Bitcoin with all the popular payment methods, such as the ones below.',
  },
  meta: {
    url: 'https://guardarian.com/buy-bitcoin-with-euro',
    title: `Buy ${coin.name} (${coin.tickerUpper}) with EUR - Guardarian`,
    description: `Guardarian is the easiest way to buy & sell Bitcoin. Exchange EUR to BTC and BTC to EUR without registration or any hidden fees.`,
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: `Buy ${coin.name} (${coin.tickerUpper}) with EUR Instantly`,
    text: 'Bitcoin is an independent currency. What distinguishes this cryptocurrency from common currencies such as dollars or euros is that it is not owned by any state. In other words, Bitcoin is  an essentially decentralized currency because there is no central bank, government, financial institution, or company that acts on them. With Guardarian you can buy BTC with Euro without registration and with no hidden fees. ',
    info: {
      release: 2009,

...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Tether (USDT) With Bank Transfer - Guardarian ',
    description:
      'Buy Tether with SEPA Instant, Swift, or Faster Payments without registration. Best exchange rate and no hidden fees on Guardarian.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Tether (USDT) with Bank Transfer',

...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Ethereum (ETH) With Bank Transfer - Guardarian',
    description:
      'Buy Ethereum with SEPA Instant, Swift, or Faster Payments without registration. Best exchange rate and no hidden fees on Guardarian.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Ethereum (ETH) with Bank Transfer',

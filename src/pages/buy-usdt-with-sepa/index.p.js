...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Tether (USDT) With SEPA in Europe - Guardarian',
    description:
      'Easiest way to buy & sell Tether with SEPA bank transfer. Get the best exchange rate and no hidden fees on Guardarian.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Tether (USDT) with SEPA',

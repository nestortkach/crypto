...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Tether (USDT) With AUD - Guardarian',
    description:
      'Guardarian is the easiest way to buy & sell Tether. Exchange AUD to USDT and USDT to AUD without registration or any hidden fees.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Tether (USDT) with AUD',

...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Ethereum (ETH) With Credit/Debit Card - Guardarian',
    description:
      'Buy Ethereum fast with Visa or Mastercard without registration. Best exchange rate and no hidden fees on Guardarian.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Ethereum (ETH) with Credit/Debit Card',

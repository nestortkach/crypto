...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Tether (USDT) | Buy USDT with Fiat, EUR & USD',
    description:
      'Guardarian offers the most user-friendly environment for purchasing USDT. Get the best EUR & USD to USDT exchange rate at Guardarian.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Tether (USDT)',

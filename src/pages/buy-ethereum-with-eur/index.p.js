...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Ethereum (ETH) with EUR - Guardarian',
    description:
      'Guardarian is the easiest way to buy & sell Ethereum. Exchange EUR to ETH and ETH to EUR without registration or any hidden fees.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Ethereum (ETH) with EUR',

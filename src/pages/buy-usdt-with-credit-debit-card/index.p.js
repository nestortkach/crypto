...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Tether (USDT) With Credit/Debit Card - Guardarian',
    description:
      'Buy Tether fast with Visa or Mastercard without registration. Best exchange rate and no hidden fees on Guardarian.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Tether (USDT) with Credit/Debit Card',

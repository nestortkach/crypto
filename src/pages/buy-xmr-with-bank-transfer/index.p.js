...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Monero (XMR) With Bank Transfer - Guardarian',
    description:
      'Buy Monero with SEPA Instant, Swift, or Faster Payments without registration. Best exchange rate and no hidden fees on Guardarian.',
  },
  banner: {
    title: 'Buy Monero (XMR) with Bank Transfer',

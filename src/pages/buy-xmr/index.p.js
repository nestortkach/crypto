...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Monero (XMR) | Buy XMR with Fiat, EUR & USD',
    description:
      'Guardarian offers the most user-friendly environment for purchasing Monero. Get the best EUR & USD to XMR exchange rate at Guardarian.',
  },
  banner: {
    title: 'Buy Monero (XMR)',

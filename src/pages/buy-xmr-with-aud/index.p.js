...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Monero (XMR) With AUD - Guardarian',
    description:
      'Guardarian is the easiest way to buy & sell Monero. Exchange AUD to XMR and XMR to AUD without registration or any hidden fees.',
  },
  banner: {
    title: 'Buy Monero (XMR) with AUD',

...
const pageInfo = {
  isBitcoinPage: true,
  bitcoinPageInfo: {
    exchangeButtonText: 'Buy Bitcoin with AUD',
    howToBuyButtonText: 'Buy BTC with AUD',
    exchangeText: 'Choose payment method that suits you most and buy BTC with AUD with the lowest fees.',
    howToBuyHeader: 'How to buy Bitcoin (BTC) with AUD Instantly?',
    howToBuySubHeader:
      'Follow these simple steps to purchase Bitcoin with AUD instantly using any major payment method.',
    fiatName: {
      upper: 'AUD',
    },
    isPaymentMethod: false,
    popularPaymantSubheader: 'Use AUD to buy Bitcoin with all the popular payment methods, such as the ones below.',
  },
  meta: {
    url: 'https://guardarian.com/buy-bitcoin-with-aud',
    title: `Buy ${coin.name} (${coin.tickerUpper}) With AUD - Guardarian`,
    description: `Guardarian is the easiest way to buy & sell Bitcoin. Exchange AUD to BTC and BTC to AUD without registration or any hidden fees.`,
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: `Buy ${coin.name} (${coin.tickerUpper}) with AUD Instantly`,
    text: 'Bitcoin is an independent currency. What distinguishes this cryptocurrency from common currencies such as dollars or euros is that it is not owned by any state. In other words, Bitcoin is  an essentially decentralized currency because there is no central bank, government, financial institution, or company that acts on them. With Guardarian you can buy BTC with Australian Dollars without registration and with no hidden fees. ',
    info: {
      release: 2009,
  ...
  otherCurrensies: {
    ...
    logo: '/btc/btc-bg.svg',
    otherCurrencies: [
      { name: 'usd', img: '/usd-change.png', route: '/buy-bitcoin-with-usd' },
      { name: 'eur', img: '/eur-change.png', route: '/buy-bitcoin-with-euro' },
      { name: 'gbp', img: '/gbp-change.png', route: '/buy-bitcoin-with-gbp' },
      { name: 'sek', img: '/sek-change.png', route: '/buy-bitcoin-with-sek' },
    ],
  },
};

...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Monero (XMR) With SEPA in Europe - Guardarian',
    description:
      'Easiest way to buy & sell Monero with SEPA bank transfer. Get the best exchange rate and no hidden fees on Guardarian.',
  },
  banner: {
    title: 'Buy Monero (XMR) with SEPA',

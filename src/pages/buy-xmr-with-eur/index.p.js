...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Monero (XMR) with EUR - Guardarian',
    description:
      'Guardarian is the easiest way to buy & sell Monero. Exchange EUR to XMR and XMR to EUR without registration or any hidden fees.',
  },
  banner: {
    title: 'Buy Monero (XMR) with EUR',

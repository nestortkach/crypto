...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Monero (XMR) with GBP - Guardarian',
    description:
      'Guardarian is the easiest way to buy & sell Monero. Exchange GBP to XMR and XMR to GBP without registration or any hidden fees.',
  },
  banner: {
    title: 'Buy Monero (XMR) with GBP',

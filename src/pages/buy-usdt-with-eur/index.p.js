...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Tether (USDT) with EUR - Guardarian',
    description:
      'Guardarian is the easiest way to buy & sell Tether. Exchange EUR to USDT and USDT to EUR without registration or any hidden fees.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Tether (USDT) with EUR',

...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Ethereum (ETH) With AUD - Guardarian',
    description:
      'Guardarian is the easiest way to buy & sell Ethereum. Exchange AUD to ETH and ETH to AUD without registration or any hidden fees.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Ethereum (ETH) with AUD',

...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Ethereum (ETH) With Faster Payments - Guardarian',
    description:
      'Easiest way to buy & sell Ethereum with Faster Payments (FPS). No registration and best exchange rate on Guardarian. ',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Ethereum (ETH) with Faster Payment',

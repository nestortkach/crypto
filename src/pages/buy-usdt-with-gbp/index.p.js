...
const pageInfo = {
  meta: {
    ...
    title: 'Buy Tether (USDT) with GBP - Guardarian',
    description:
      'Guardarian is the easiest way to buy & sell Tether. Exchange GBP to USDT and USDT to GBP without registration or any hidden fees.',
    image: 'https://guardarian.com/services/sell-crypto-mobile.png',
  },
  banner: {
    title: 'Buy Tether (USDT) with GBP',

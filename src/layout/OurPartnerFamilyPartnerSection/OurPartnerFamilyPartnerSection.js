...
const OurPartnerFamilyPartnerSection = memo(({ withoutBg, headerBlue, integrateUs }) => {
  ...
  return (
    <div className={withoutBg ? css.howToBuySectionPartners : css.howToBuySection}>
      <div className='container'>
        ...
        {!headerBlue && (
          <div>
            <h2 className={withoutBg ? css.headingPartners : css.heading}>Trusted by the best</h2>
            <p className={css.subtitle}>Guardarian powers the leading projects in Web3 industry.</p>
          </div>
        )}

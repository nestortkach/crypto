        ...
        <div className={css2.container}>
          <section className={css2.component}>
            <div className={css2.actionArea}>
              <h1>Create stable revenue streams with recurring fiat-to-crypto transactions</h1>
            ...
            <div className={css2.calculatorArea}>
              {isMobile && urlParams && <img src='/subscription-image-mobile.webp' width={279} alt='iphone' />}

              {!isMobile && urlParams && (
                <div className={css.formWrap}>
                  <img className={css2.imagePhone} src='/subscription-image-desktop.webp' width={381} alt='iphone' />
